...
const queryParams = ref<any>({
    ...
    prodQuantityVal: '',
    tradeTerms_selectVal: 'FOB',
    onMaxBudget_selectVal: 'Please select',
    onSourcingType_selectVal: 'Please select',
    shippingMaxBudget_select: 'Sea freight',
    destination_select: 'China',
    paymentMethod_select: 'T/T',
    priceUnit_select: 'USD',
    fullName: '',
    detailsVal: '',
    verificationCode: '',
    phoneNumberVal: '',
...
const onSubmit = async () => {
    if (checkbox.value) {
        queryParams.value.prodQuantityVal = +queryParams.value.prodQuantityVal
        queryParams.value.leadTimeVal = +queryParams.value.leadTimeVal
        queryParams.value.fileUrl_list = fileUrl_list.value.join(',')
        // 获取世界时间格式
        ...
        if (new Date().getUTCMonth() + 1 >= 10) {
            ...
            queryParams.value.inquiryLocalTime = utc[3] + '-' + month + '-' + date + 'T' + utc[4] + '.' + millseconds + 'Z'
        } else {
        ...
        await saveCommInquiry(Object.assign(queryParams.value)).then(res => {
            if (res.data.type === 'success') {
                ...
                queryParams.value.prodQuantityVal = ''
                queryParams.value.tradeTerms_selectVal = 'FOB'
                queryParams.value.destination_select = 'China'
                queryParams.value.priceUnit_select = 'USD'
                ...
                queryParams.value.leadTimeVal = ''
                queryParams.value.fileUrl_list = ''
                queryParams.value.shippingMaxBudget_select = 'Sea freight'
                queryParams.value.onMaxBudget_selectVal = 'Please select'
                queryParams.value.onSourcingType_selectVal = 'Please select'
                queryParams.value.businessEmailVal = ''
                queryParams.value.quantityType = 'Piece(s)'
                queryParams.value.paymentMethod_select = 'T/T'
            } else {
...
const handleSelectCategory = () => {
    transferModels.value.openDialog()
}
const eCategoryParentID = (item: string) => {
    queryParams.value.categoryID = +item
}
const CategoryList = (item: any) => {
    item.map((ite: any) => {
        CateList.value += ite + ' >> '
    })
    CateList.value = CateList.value.replaceAll("&amp;", '&')
    CateList.value = CateList.value.substring(0, CateList.value.length - 3)
}
...
<template>
    <div class="content">
        <div class="block-title">Basic Product Information</div>
        <el-form :model="queryParams" ref="queryForm" label-width="150px" :inline="true">
            <el-row :gutter="20">
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item label="Product Name:"
                        :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                        <el-input v-model="queryParams.prodName" clearable placeholder="Enter a specific product name." />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item label="Category:">
                        <template v-if="CateList.length">
                            <label @click="handleSelectCategory" id="SelectCategory"
                                style="width: 700px; cursor: pointer; color: #1470cc; text-align: left;">{{ CateList
                                }}</label>
                        </template>
                        <template v-else>
                            <label @click="handleSelectCategory" id="SelectCategory"
                                style="width: 700px; cursor: pointer; color: #1470cc; text-align: left;">Select
                                Category</label>
                        </template>
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item label="Quantity:"
                        :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                        <el-input v-model="queryParams.prodQuantityVal" clearable placeholder="" />
                        <el-select v-model="queryParams.quantityType" placeholder="Piece(s)">
                            <el-option value="20' Container">20' Container</el-option>
                            <el-option value="40' Container">40' Container</el-option>
                            <el-option value="40' HQ Container">40' HQ Container</el-option>
                            ...
                            <el-option value="Ream(s)">Ream(s)</el-option>
                            ...
                            <el-option value="Square Foot(Feet)">Square Foot(Feet)</el-option>
                ...
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item label="Trade Terms:">
                        <el-select v-model="queryParams.tradeTerms_selectVal">
                ...
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item label="Max Budget:"
                        :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                        <el-select v-model="queryParams.onMaxBudget_selectVal">
                            <el-option value="Please select">Please select</el-option>
                            <el-option value="<1000">&lt;1000</el-option>
                            <el-option value="1000-5000">1000-5000</el-option>
                            <el-option value="5000-10000">5000-10000</el-option>
                            <el-option value="10000-50000">10000-50000</el-option>
                            <el-option value=">50000">&gt;50000</el-option>
                        </el-select>
                        <el-select v-model="queryParams.priceUnit_select">
                            <el-option value="USD">USD</el-option>
                            <el-option value="EUR">EUR</el-option>
                            <el-option value="GBP">GBP</el-option>
                            <el-option value="RMB">RMB</el-option>
                            ...
                            <el-option value="NZD">NZD</el-option>
                            <el-option value="SGD">SGD</el-option>
                            <el-option value="NTD">NTD</el-option>
                            <el-option value="Other">Other</el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item label="Sourcing Type:"
                        :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                        <el-select v-model="queryParams.onSourcingType_selectVal">
                            <el-option value="Please select">Please select</el-option>
                            <el-option value="Customized Product">Customized Product</el-option>
                            <el-option value="Non-customized Product">Non-customized Product</el-option>
                            <el-option value="Total Solution">Total Solution</el-option>
                            <el-option value="Business Service">Business Service</el-option>
                            <el-option value="Other">Other</el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
...
You may include: Color, Material, Size, Weight, Packaging and certificate requirements and/or others." rows="5" />
                        <el-upload :on-remove="removeFile" :on-success="successUpload" ref="uploadRef"
                            ...
                            <el-button @click="submitUpload">submit upload</el-button>
                        </el-upload>
                    </el-form-item>
                </el-col>
                ...
                <div class="contact-information">
                    ...
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="Business Email:"
                            :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                            <el-input v-model="queryParams.businessEmailVal" clearable placeholder="" />
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="Full Name:">
                            <el-input v-model="queryParams.fullName" clearable placeholder="" />
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="Company Name:"
                            :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                            <el-input v-model="queryParams.companyNameVal" clearable placeholder="" />
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                        <el-form-item label="Phone Number:"
                            :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                            <el-input v-model="queryParams.phoneNumberVal" clearable placeholder="" />
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    ...
                    <div class="request-more-form">
                        <div class="block-title block-title-more">Shipping and Payment</div>
                        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                            <el-form-item label="Max Budget:"
                                :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                                <el-select v-model="queryParams.shippingMaxBudget_select">
                                    <el-option value="Sea freight">Sea freight</el-option>
                                    <el-option value="Air freight">Air freight</el-option>
                                    <el-option value="Express">Express</el-option>
                                    <el-option value="Land freight">Land freight</el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                            <el-form-item label="Destination:"
                                ...
                                <el-select v-model="queryParams.destination_select">
                                    ...
                                    <el-option value="Bosnia and Herzegovina">Bosnia and Herzegovina</el-option>
                                    ...
                                    <el-option value="British Indian Ocean Territory">British Indian Ocean
                                        Territory</el-option>
                                    ...
                                    <el-option value="Central African Republic">Central African Republic</el-option>
                                    ...
                                    <el-option value="Cocos (Keeling) Islands">Cocos (Keeling) Islands</el-option>
                                    <el-option value="Colombia">Colombia</el-option>
                                    <el-option value="Comoros">Comoros</el-option>
                                    <el-option value="Congo, The Democratic Republic Of The">Congo, The Democratic
                                        Republic
                                        Of
                                        The</el-option>
                                    <el-option value="Congo, The Republic of Congo">Congo, The Republic of
                                        Congo</el-option>
                                    ...
                                    <el-option value="Croatia (local name: Hrvatska)">Croatia (local name:
                                        Hrvatska)</el-option>
                                    ...
                                    <el-option value="Dominican Republic">Dominican Republic</el-option>
                                    ...
                                    <el-option value="Equatorial Guinea">Equatorial Guinea</el-option>
                                    ...
                                    <el-option value="Falkland Islands (Malvinas)">Falkland Islands
                                        (Malvinas)</el-option>
                                    ...
                                    <el-option value="France Metropolitan">France Metropolitan</el-option>
                                    <el-option value="French Guiana">French Guiana</el-option>
                                    <el-option value="French Polynesia">French Polynesia</el-option>
                                    <el-option value="French Southern Territories">French Southern
                                        Territories</el-option>
                                    ...
                                    <el-option value="Heard and Mc Donald Islands">Heard and Mc Donald
                                        Islands</el-option>
                                    ...
                                    <el-option value="Iran (Islamic Republic of)">Iran (Islamic Republic
                                        of)</el-option>
                                    ...
                                    <el-option value="Lao People's Democratic Republic">Lao People's Democratic
                                        Republic</el-option>
                                    ...
                                    <el-option value="Netherlands Antilles">Netherlands Antilles</el-option>
                                    ...
                                    <el-option value="Northern Mariana Islands">Northern Mariana Islands</el-option>
                                    ...
                                    <el-option value="Russian Federation">Russian Federation</el-option>
                                    <el-option value="Rwanda">Rwanda</el-option>
                                    <el-option value="Saint Barthelemy">Saint Barthelemy</el-option>
                                    <el-option value="Saint Kitts and Nevis">Saint Kitts and Nevis</el-option>
                                    <el-option value="Saint Lucia">Saint Lucia</el-option>
                                    <el-option value="Saint Martin">Saint Martin</el-option>
                                    <el-option value="Saint Vincent and the Grenadines">Saint Vincent and the
                                        Grenadines</el-option>
                                    <el-option value="Samoa">Samoa</el-option>
                                    <el-option value="San Marino">San Marino</el-option>
                                    <el-option value="Sao Tome and Principe">Sao Tome and Principe</el-option>
                                    ...
                                    <el-option value="Slovakia (Slovak Republic)">Slovakia (Slovak
                                        Republic)</el-option>
                                    ...
                                    <el-option value="South Georgia and the South Sandwich Islands">South Georgia
                                        and the
                                        South
                                        Sandwich
                                        Islands</el-option>
                                    ...
                                    <el-option value="St. Pierre and Miquelon">St. Pierre and Miquelon</el-option>
                                    <el-option value="Sudan">Sudan</el-option>
                                    <el-option value="Suriname">Suriname</el-option>
                                    <el-option value="Svalbard and Jan Mayen Islands">Svalbard and Jan Mayen
                                        Islands</el-option>
                                    ...
                                    <el-option value="Syrian Arab Republic">Syrian Arab Republic</el-option>
                                    ...
                                    <el-option value="Vatican City State (Holy See)">Vatican City State (Holy
                                        See)</el-option>
                                    <el-option value="Venezuela">Venezuela</el-option>
                                    <el-option value="Vietnam">Vietnam</el-option>
                                    <el-option value="Virgin Islands (British)">Virgin Islands (British)</el-option>
                                    <el-option value="Virgin Islands (U.S.)">Virgin Islands (U.S.)</el-option>
                                    <el-option value="Wallis And Futuna Islands">Wallis And Futuna
                                        Islands</el-option>
                        ...
                        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                            <el-form-item label="Lead Time:"
                                :rules="[{ required: true, message: 'Please enter a number above 0.', trigger: 'blur' }]">
                                <div class="layui-row">
                                    <label class="layui-form-label layui-col-md3" style="width: 74px;">
                                        Ship in
                                    </label>
                                    <div class="layui-col-md1">
                                        <el-input :input-style="{ width: '50px' }" v-model="queryParams.leadTimeVal"
                                            clearable placeholder="" />
                                    </div>
                                    <label class="layui-form-label layui-col-md8" style="width: 335px;">
                                        day(s) after supplier receives the initial paypment
                                    </label>
                                </div>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                            <el-form-item label="Payment Method:"
                                :rules="[{ required: true, message: 'Please fill in the required fields before submitting.', trigger: 'blur' }]">
                                <el-select v-model="queryParams.paymentMethod_select" placeholder="请选择">
                                    <el-option value="T/T">T/T</el-option>
                                    <el-option value="L/C">L/C</el-option>
                                    <el-option value="D/P">D/P</el-option>
                                    <el-option value="Western Union">Western Union</el-option>
                                    <el-option value="Money Gram">Money Gram</el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                            <el-form-item label=" ">
                                <el-checkbox v-model="checkbox"
                                    label="I agree to share my Business Card with quoted suppliers." size="large" />
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                            <el-form-item label=" ">
        ...
        <transferModel ref="transferModels" @eCategoryParentID="eCategoryParentID" @CategoryList="CategoryList" />
    </div>
</template>
