...
const submit = async () => {
    ...
    if (localhost !== 'localhost') {
        // 验证码是否正确
        import.meta.env.VITE_API_URL = 'http://www.ecvv.com'
...
const submitFrom = () => {
    ...
    var ipjson = '{ "PONO":"","Platform":2,"Ip":"219.133.106.59","Country":"中国"}';
    var data = {
        "order": {
            "source": 2,
            "totalAmount": {
            ...
            "orderItems": [
                {
                    "productName": "ECVV Miniature Circuit Breaker TGB1N-125 2PTGB1N-1252P-D-80A 6KA TENGEN MCB",
                    "productTotalPrice": {
                        "currency": "USD",
                        "unit": "元",
                        "value": ruleForm.value.totalPrice
                    ...
                    "deliveryTime": year + '-' + month + '-' + date + "T00:00:00.000Z",
                    "productSpecs": getUrlParam("dvSkuDetail") ? getUrlParam("dvSkuDetail") : "",
    ...
    service({
        ...
        headers: { "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..3hUv2uMDgrB77j2-L4tzfw79f6yro2gDFIMDQcLxmiA" }
    }).then((res) => {
...
// 响应头 headerObj
const headerObj = {Authorization:'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..3hUv2uMDgrB77j2-L4tzfw79f6yro2gDFIMDQcLxmiA' }
//将属性或者函数暴露给父组件
...
<template>
    <div class="popups-content">
        <el-dialog v-model="dialogTableVisible" title="Submit an EOI" @close="closeDialog">
            <div class="popups-header">
                <p id="orderProductName">{{ props.ProductDataInfo.productName }}</p>
                <div class="popups-header-img" id="dvProductImg">
                    <img :src="props.ProductDataInfo.firstPicPath">
                    <div class="popups-header-fob" style="display:inline-flex">
                        <p span="" class="header-fob-p1" id="pFobPrice">
                            FOB Reference Price
                            <span><br>
                ...
                <div>
                    <el-form model="ruleForm" ref="ruleFormRef" size="default" label-width="100px">
                        <el-row :gutter="35">
                            ...
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control">
                                <el-form-item prop="BuyerName">
                                    <el-input v-model="ruleForm.BuyerName" placeholder="Name" clearable />
                                </el-form-item>
                            </el-col>
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control">
                                <el-form-item prop="BuyerEmail">
                                    <el-input v-model="ruleForm.BuyerEmail" placeholder="Email" clearable />
                                </el-form-item>
                            </el-col>
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control">
                                <el-form-item prop="BuyerTel">
                                    <el-input v-model="ruleForm.BuyerTel" placeholder="Mobile/Telephone" clearable />
                                </el-form-item>
                            </el-col>
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control">
                                <el-form-item prop="BuyerCountry">
                                    <el-select v-model="ruleForm.BuyerCountry" placeholder="Please Select Country"
                                        clearable>
                                        ...
                                        <el-option value="Falkland Islands (Malvinas)">Falkland Islands (Malvinas)
                                        </el-option>
                                        ...
                                        <el-option value="French Southern Territories">French Southern Territories
                                        </el-option>
                                        ...
                                        <el-option value="Heard and Mc Donald Islands">Heard and Mc Donald Islands
                                        </el-option>
                                        ...
                                        <el-option value="Iran (Islamic Republic of)">Iran (Islamic Republic of)
                                        </el-option>
                                        ...
                                        <el-option value="Lao Peoples Democratic Republic">Lao Peoples Democratic Republic
                                        </el-option>
                                        ...
                                        <el-option value="Libyan Arab Jamahiriya">Libyan Arab Jamahiriya </el-option>
                                        ...
                                        <el-option value="Singapore">Singapore</el-option>
                                        <el-option value="Slovakia (Slovak Republic)">Slovakia (Slovak Republic)</el-option>
                                        ...
                                        <el-option value="United States">United States</el-option>
                                        <el-option value="United States Minor Outlying Islands">United States Minor Outlying
                                            Islands
                                        </el-option>
                                        ...
                                        <el-option value="Vatican City State (Holy
                                    See)">Vatican City State (Holy See) </el-option>
                                        ...
                                        <el-option value="Wallis And Futuna Islands">Wallis And Futuna Islands</el-option>
                            ...
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control">
                                <el-form-item prop="productNumber">
                                    <el-input-number v-model="ruleForm.productNumber" value="1" placeholder="Quantity"
                                        @keyup="(val: any) => { val = val.replace(/[^0-9.]+/, '') }" clearable />
                                </el-form-item>
                            </el-col>
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control">
                                <el-form-item prop="unit">
                                    <el-select v-model="ruleForm.unit" placeholder="Please Select Unit" clearable>
                                        ...
                                        <el-option value="Cubic Centimeter(s)">Cubic Centimeter(s)</el-option>
                                        <el-option value="Cubic Foot/Cubic Feet">Cubic Foot/Cubic Feet</el-option>
                                        ...
                                        <el-option value="Degrees Fahrenheit">Degrees Fahrenheit</el-option>
                                        ...
                                        <el-option value="Forty-Foot Container">Forty-Foot Container</el-option>
                                        ...
                                        <el-option value="Square Centimeter(s)">Square Centimeter(s)</el-option>
                                        <el-option value="Square Foot/Square Feet">Square Foot/Square Feet</el-option>
                                        ...
                                        <el-option value="Twenty-Foot Container">Twenty-Foot Container</el-option>
                            ...
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control textCode">
                                <el-form-item prop="textVcode">
                                    <el-input v-model="ruleForm.textVcode" placeholder="Verification Code" clearable />
                                    <img src="https://www.ecvv.com/ecvvajax/checkcode.ashx"
                                        @click="(e: any) => { e.target.src = e.target.src + '?' + Math.random(); }">
                                </el-form-item>
                            </el-col>
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control">
                                <el-form-item prop="textVcode">
                                    <el-date-picker v-model="ruleForm.deliveryTime" type="date" placeholder="Delivery Time"
                                        size="16" />
                                </el-form-item>
                            </el-col>
                            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="form-control">
                                <el-form-item prop="treaProcurementDescribes">
                                    <el-input v-model="ruleForm.treaProcurementDescribes"
                                        :autosize="{ minRows: 2, maxRows: 4 }" type="textarea"
                                        placeholder="Please enter your detailed requirements, such as product name, specifications, etc. Also you can upload attachments like product pictures..." />
                                    <br> Include ,delivery time sample, etc.</el-form-item>
                            </el-col>
                            ...
                            <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" class="form-control submit">
                                <el-form-item prop="btnSub">
                                    <el-input type="button" id="btnSub" @click="submit" value="Submit Order" />
                                </el-form-item>
                            </el-col>
                        </el-row>
                    </el-form>
                </div>
                <div class="popups-bottom-l">
                    <div class="supension-p">
                        <p>
                            The First China End-to-End</p>
                        <p>
                            Purchasing Service Website with Quality</p>
                        <p>
                            Assurance and Warranty for Global Buyers</p>
                    </div>
                    <ul class="supension-ul">
                        <li>
                            <img src="//eresource.ecvv.com/PC_Ecvv/productOrder/images/productsus1.png">
                            <p>
                                Payment security</p>
                        </li>
                        <li>
                            <img src="//eresource.ecvv.com/PC_Ecvv/productOrder/images/productsus2.png">
                            <p>
                                Quality Control</p>
                        </li>
                        <li>
                            <img src="//eresource.ecvv.com/PC_Ecvv/productOrder/images/productsus3.png">
                            <p>
                                Supply Chain</p>
                        </li>
                    </ul>
...
.popups-content {
    ...
    .popups-bottom-l .supension-p p {
        text-align: center;
        font-size: 16px;
        margin-bottom: 10px;
    }

    .popups-bottom-l .supension-ul {
        letter-spacing: -4px;
        margin-top: 30px;
    }

    .popups-bottom-l .supension-ul li {
        letter-spacing: 0;
    ...
    .popups-bottom-l .supension-ul li img {
        width: 100px;
    }
