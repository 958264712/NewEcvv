    ...
    <div class="form">
      ...
      <div class="productInfo">
        ...
        <div class="prod-detail-r">
          <a
           @click="clickProduct(productInfo.productID)"
            class="prod-name"
          ...
          <div class="prod-quantity cf">
            ...
            <div class="quantity-item it-unit">
              ...
              <span class="item-txt">{{productInfo.productUnit}}(s)</span>
            </div>
            ...
            <div class="quantity-item it-price">
              ...
              <span class="item-txt J-sample" cz-price="33.55">{{productInfo.priceUnit}} {{productInfo.productPrice}}</span>
            </div>
            <div class="quantity-item it-total">
              <span class="item-title">Total</span>
              <span class="item-txt total J-total">{{productInfo.priceUnit}}{{productInfo.productPrice * ruleForm.productNumber }}</span>
            </div>
          </div>
          <div>
